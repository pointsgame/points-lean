...
inductive AdjacentRight: Pos width height → Pos width height → Prop where
...
inductive AdjacentBottom: Pos width height → Pos width height → Prop where
...
inductive AdjacentBottomRight: Pos width height → Pos width height → Prop where
...
inductive AdjacentTopRight: Pos width height → Pos width height → Prop where
...
noncomputable def AdjacentLeft (pos₁: Pos width height) (pos₂: Pos width height): Prop :=
  AdjacentRight pos₂ pos₁

noncomputable def AdjacentTop (pos₁: Pos width height) (pos₂: Pos width height): Prop :=
  AdjacentBottom pos₂ pos₁

noncomputable def AdjacentTopLeft (pos₁: Pos width height) (pos₂: Pos width height): Prop :=
  AdjacentBottomRight pos₂ pos₁

noncomputable def AdjacentBottomLeft (pos₁: Pos width height) (pos₂: Pos width height): Prop :=
